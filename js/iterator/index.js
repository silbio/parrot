...
async function refresh(provincePath, procedureCode, rowId) {
        ...
        pageMaker.run(pageId, provincePath, procedureCode, userAgentString)
            .then((resolution) => {
                ...
                iterationResults[rowId].provincePath =provincePath;
                iterationResults[rowId].procedureCode= procedureCode;
                iterationResults[rowId].offices= resolution.offices;
                iterationResults[rowId].finished = true;
