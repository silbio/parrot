...
// TODO => - add contact form and phone numbers to website
// TODO => Improve aesthetics
// TODO => Add about us area.
let activePolls = {};
...
function updateDashboard(rowStatus) {
    ...
    for (let rowId in rowStatus) {
        if (rowStatus.hasOwnProperty(rowId)) {
            ...
            if (areThereOffices && isRowUnmuted) {
                snd.play();
            }
        }
    }
...
//Send the proper header information along with the request
        ...
        console.error('Error Comunicando con el servidor. ' + err);
    })
}
